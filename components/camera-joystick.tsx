...
export function CameraJoystick({ onMove }: CameraJoystickProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed bottom-8 right-8 w-32 h-32 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/40 flex items-center justify-center"
    >
      <div
